...
def game(size, grid_main, minesHit, moveOrder):
    ...
    while (len(moveOrder) > 0):
        ...
        if grid_main[x][y] == -1 and ( (x,y) not in minesHit ):
            ...
            text = font.render(str(int(grid_main[x][y])), True, (0,0,0))
